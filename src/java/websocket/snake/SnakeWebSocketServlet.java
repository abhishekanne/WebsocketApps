...
public class SnakeWebSocketServlet extends WebSocketServlet {
    ...
    private static final Logger log = Logger.getLogger(SnakeWebSocketServlet.class.toString());
        ...
        gameTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    log.log(Level.SEVERE,"Caught to prevent timer from shutting down", e);
                }
            }
